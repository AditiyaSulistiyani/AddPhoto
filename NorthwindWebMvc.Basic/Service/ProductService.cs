...
namespace NorthwindWebMvc.Basic.Service
{
    ...
    {
        private readonly IRepositoryBase<Produk> _repositoryBase;
        private readonly IMapper _mapper;

        public ProductService(IRepositoryBase<Produk> repositoryBase, IMapper mapper)
        {
        ...
        {
            var product=_mapper.Map<Produk>(entity);
